  ...
  return (
    <section className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-2xl w-full flex flex-col items-center text-center">
        ...
        >
          <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-white/80 shadow-md bg-white flex items-center justify-center p-1.5">
            <img src="/images/bedune_logo_cropped.png" alt="BEDUINE" className="w-full h-full object-contain" />
          </div>
