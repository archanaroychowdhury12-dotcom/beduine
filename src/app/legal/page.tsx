    ...
    <div className="relative min-h-screen bg-[#030C15] pt-24 lg:pt-32 pb-16 px-4 sm:px-6 lg:px-8 text-white">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan/25 bg-cyan/10 text-cyan text-[11px] font-bold font-mono uppercase tracking-wider mb-4">
            <ShieldCheck className="w-3.5 h-3.5" />
            <span>Compliance Integrity</span>
          </div>
          <h1 className="font-display text-3xl sm:text-5xl font-black text-white tracking-tight leading-tight mb-4">
        ...
        {filteredPolicies.length === 0 ? (
          <div className="text-center py-16 bg-white/5 backdrop-blur-md rounded-[24px] border border-white/10 p-8 max-w-md mx-auto">
            <Compass className="w-10 h-10 text-slate-400 mx-auto mb-4 animate-pulse" />
            <h3 className="font-display font-bold text-base text-white mb-1">No policies found</h3>
