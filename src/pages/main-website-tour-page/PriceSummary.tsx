      ...
      <div className={`space-y-5 text-left ${isMobileSheet ? 'text-slate-800' : 'text-white'}`}>
        ...
        <div className="pt-3 border-t border-slate-200/10 flex justify-between items-baseline">
          <div className="text-left">
            <span className={`text-[10px] uppercase font-bold tracking-widest block ${isMobileSheet ? 'text-slate-400' : 'text-slate-450'}`}>Total Amount</span>
            <span className="text-[10px] text-slate-500 font-medium block">Inclusive of taxes</span>
          </div>
    ...
    <>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[140] bg-slate-900 border-t border-slate-850 text-white shadow-2xl p-4 flex flex-col">
        ...
        <div className="flex items-center justify-between">
          <div className="text-left">
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] text-slate-400 uppercase font-black tracking-wider">Payable</span>
              {totalSavings > 0 && (
