    ...
    <header className="bg-white border-b border-slate-200/80 py-4 px-4 sm:px-6 lg:px-8 text-left shadow-sm">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center justify-between md:justify-start gap-6">
          ...
          >
            <div className="w-9 h-9 rounded-xl overflow-hidden border bg-white flex items-center justify-center p-1 shadow-sm group-hover:scale-105 transition-transform shrink-0">
