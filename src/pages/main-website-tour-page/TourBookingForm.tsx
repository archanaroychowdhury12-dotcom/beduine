...
import { DiscountCreditsSelector } from './DiscountCreditsSelector';
              ...
              <div className={`bg-white border rounded-3xl transition-all duration-300 ${
                ...
                {bookingStep !== 2 ? (
                  ...
                  <div className="space-y-6 animate-fadeIn">
                    ...
                    />
                    <DiscountCreditsSelector
                      currentUser={currentUser}
                      availableDomesticCredits={availableDomesticCredits}
                      availableInternationalCredits={availableInternationalCredits}
                      creditSelection={creditSelection}
                      handleSelectCreditCategory={handleSelectCreditCategory}
                      creditError={creditError}
                      creditSuccess={creditSuccess}
                      appliedDiscountCredits={appliedDiscountCredits}
                      handleUpdateAppliedCredits={handleUpdateAppliedCredits}
