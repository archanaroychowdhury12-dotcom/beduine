...
export function PolicyVersion({ version }: PolicyVersionProps) {
  return (
    <div className="mt-12 p-4 rounded-xl border border-amber-500/15 bg-amber-500/5 text-amber-600 dark:text-amber-400 text-[10px] sm:text-xs flex items-start gap-2.5 font-mono leading-relaxed select-none">
