...
import {
  Sparkles, Gift, CreditCard, Award, ShieldCheck,
  ChevronRight, CheckCircle2, Check, Star,
  Phone, Calendar, MapPin, Plane,
  FileCheck2, ArrowRight, MessageCircle,
...
export function ParticleButton({ children, onClick, variant = 'gold', className = '', ...rest }: any) {
    ...
    <>
      ...
      <div className="relative video-bg-container">
        ...
        <div className="relative z-10 flex flex-col gap-8 lg:gap-12">
          ...
          <ScrollRoundedSection><CTABanner onSelectPlan={onSelectPlan} /></ScrollRoundedSection>
        </div>
      </div>
    </>
  );
