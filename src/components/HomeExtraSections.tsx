...
export const TestimonialCarouselSection: React.FC = () => {
  const reviews = [
    ...
    { name: 'Carlos Mendoza', role: 'Photographer', location: 'Buenos Aires', img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&auto=format&fit=crop&q=80', quote: 'Patagonia trek was the most rewarding adventure of my life. The expert guides, the eco-domes, the wildlife — every moment was curated perfectly.', tour: 'Patagonia Fjord Trek', rating: 5 },
