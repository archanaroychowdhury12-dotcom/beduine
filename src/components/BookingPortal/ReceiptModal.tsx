...
export const ReceiptModal: React.FC<ReceiptModalProps> = ({ confirmation, onClose }) => {
  const { bookingId, tour, selectedDate, travelers, pricing, isPrivateTour, confirmedAt, pickup } = confirmation;
        ...
        <div className="p-8 sm:p-12 space-y-10">
              ...
              <table className="w-full text-left text-sm font-medium">
                ...
                <tfoot className="bg-slate-900 text-white font-black text-base font-serif-premium">
                  <tr>
                    ...
                    <td className="py-4 px-4 text-right text-amber-400 font-mono text-xl">{formatINR(pricing.totalPayable)}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
          ...
          <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            <div className="flex items-center space-x-2 text-emerald-700 font-bold">
              ...
              <span>100% Fully Refundable up to 48 hours prior to scheduled departure.</span>
            </div>
