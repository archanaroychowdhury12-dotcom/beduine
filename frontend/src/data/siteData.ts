...
export const NAV = [
  ...
  { id: 'luckydraw', label: 'Travel Reward (TRC)', icon: Ticket },
...
export const PLANS = [
  {
    ...
    benefits: ['1 Travel Reward Credit (TRC)', 'Eligible for weekly winner selection', '₹500 Domestic Discount Credit for eligible non-winners only', 'Up to 5% off on paid domestic tours', '12-month subscription validity', '18+ Membership Only'],
  },
  {
    ...
    benefits: ['1 Travel Reward Credit (TRC)', 'Eligible for weekly winner selection', '2 × ₹500 Domestic Discount Credits for eligible non-winners only', 'Up to 7% off on paid domestic tours', 'One-time family name change allowed', '18+ Membership Only'],
  },
  {
...
export const INTL_PLANS = [
  {
    ...
    benefits: ['1 Travel Reward Credit (TRC)', 'Eligible for weekly winner selection', '₹5,000 International Discount Credit for eligible non-winners only', 'Up to 5% off on paid international tours', 'One-time family name change allowed', '18+ Membership Only'],
  },
  {
    name: 'Gold', price: 7999, tagline: 'Premium Explorer', icon: Plane,
    color: 'from-emerald-400 to-teal-600', glow: 'teal',
    featured: true, tourValue: 50000, duration: '4N / 5D', discountCredits: 2, discountValue: 5000,
    ...
    benefits: ['1 Travel Reward Credit (TRC)', 'Eligible for weekly winner selection', '2 × ₹5,000 International Discount Credits for eligible non-winners only', 'Up to 7% off on paid international tours', 'Two family name changes allowed', '18+ Membership Only'],
  },
  {
    name: 'Platinum', price: 14999, tagline: 'Ultimate World Pass', icon: Rocket,
    color: 'from-cyan via-cyan-bright to-cyan-deep', glow: 'cyan',
    tourValue: 100000, duration: '5N / 6D', discountCredits: 4, discountValue: 5000,
    ...
    benefits: ['1 Travel Reward Credit (TRC)', 'Eligible for weekly winner selection', '4 × ₹5,000 International Discount Credits for eligible non-winners only', 'Up to 10% off on paid international tours', 'Unlimited name changes allowed', '18+ Membership Only'],
  },
];
...
export const SERVICES = [
  ...
  { icon: MapPin, title: 'Destination Planning', desc: 'Handpicked domestic and international routes with clear day-by-day guidance.', image: '/images/service_tours.png' },
  ...
  { icon: ShieldCheck, title: 'Booking Support', desc: 'Assisted booking flow, receipt handling, and post-booking support.', image: '/images/support_agent.png' },
  { icon: MessageCircle, title: 'Member Helpdesk', desc: 'Dedicated helpdesk for membership, credits, and tour-related questions.', image: '/images/selection_support_icon.png' },
];
...
export const HERO_SLIDES = [
  {
    ...
    title1: 'Explore More.',
    title2: 'Pay Less.',
    desc: "Subscribe once for 12 months. Get 1 TRC for weekly win-entry participation. Discount Credits are issued only to eligible non-winners after Travel Reward/TRC participation. Domestic DC and International DC cannot be cross-used.",
  },
  {
    image: '/images/kashmir_dal_lake_1779521728036.png',
