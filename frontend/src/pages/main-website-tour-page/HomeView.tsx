...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  /*
    ...
    { name: 'Carlos Mendoza', role: 'Photographer, Buenos Aires', img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&auto=format&fit=crop&q=80', quote: 'Patagonia trek was the most winner benefiting adventure of my entire life. The expert guides, eco-domes, and wildlife — every single moment was perfectly curated.', tour: 'Patagonia Fjord Trek' },
