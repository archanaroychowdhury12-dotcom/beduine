...
export function Navbar({ view, setView, currentUser, setCurrentUser: _setCurrentUser, introComplete }: NavbarProps) {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const sections = ['about', 'plans', 'destinations', 'reviews', 'contact'];
      let closestSection = '';
        ...
        >
          ...
          <div className="relative flex items-center justify-between gap-1 lg:gap-1.5 xl:gap-3 px-2 sm:px-4 lg:px-3 xl:px-4 h-14 lg:h-16">
            <div className="flex items-center gap-1 lg:gap-1.5 xl:gap-3 min-w-0">
              ...
              >
                <div 
                  className="relative w-10 h-10 lg:w-11 lg:h-11 rounded-full overflow-hidden border-2 bg-white shadow-lg shadow-cyan-900/10 transition-transform duration-300 group-hover:scale-105"
                ...
                >
                  ...
                  <span className="absolute bottom-0.5 right-0.5 h-2.5 w-2.5 rounded-full border-2 border-white bg-[#00A676]" />
                </div>
            ...
            <div className="hidden lg:flex items-center gap-1 xl:gap-1.5">
              {currentUser ? (
                <>
                  ...
                  >
                    <ParticleButton as="span" variant={isDashboard ? 'teal' : 'cyan'} className="px-2 xl:px-3 py-1.5 rounded-full font-bold text-[10px] xl:text-[11.5px] inline-flex items-center gap-1 xl:gap-1.5 text-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-900/80">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-12 h-12 rounded-full overflow-hidden border border-cyan/30 shadow-lg shadow-cyan/20 bg-white">
                <img src="/images/bedune_logo_cropped.png" alt="BEDUINE Logo" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <p className="text-sm text-[#D8E4EA] leading-relaxed max-w-sm mb-6 opacity-85">
              India's subscription-first travel company - built on transparency, available value, and journeys that live forever.
            </p>
        ...
        <div className="mt-8 pt-6 border-t border-slate-900/80 text-center text-xs text-[#AFC0CA]/40 font-mono">
          ...
          <div className="mt-4 leading-relaxed font-sans text-[11px] text-[#AFC0CA]/50">
            ...
            <span className="text-[10px] text-amber-500/80 font-semibold">
              ⚠️ 18+ Membership Required. Beduine operates a travel membership & winner benefit program. All benefits, discounts, and travel services are subject to company policies and terms.
            </span>
            <div className="mt-3.5 flex flex-wrap justify-center items-center gap-x-3 gap-y-1.5 text-[11px] font-sans text-cyan">
              ...
              <span className="text-slate-800">•</span>
              <a href="/payment-policy" onClick={(e) => handleLinkClick(e, 'payment-policy')} className="hover:text-white transition-all underline">Payment Policy</a>
              <span className="text-slate-800">•</span>
...
export function MobileSticky({ onSelectPlan: _onSelectPlan }: { onSelectPlan: (planName: string) => void }) {
  return (
