          ...
          <Reveal>
            <div className="max-w-4xl mx-auto rounded-3xl border border-white/10 bg-slate-950/40 backdrop-blur-md px-8 py-6 flex flex-wrap md:flex-nowrap justify-around items-center gap-6 shadow-xl shadow-black/20 my-16 divide-y md:divide-y-0 md:divide-x divide-white/10">
              {[
                ...
                { icon: ShieldCheck, title: 'Travel Guarantee', desc: 'Available credits, zero risk.' },
              ].map((item) => (
...
export function HowItWorks() {
  const steps = [
    ...
    { n: '03', icon: Wallet, title: 'Activate TRC', desc: 'After subscription activation, receive 1 TRC for weekly win-entry participation. Discount Credits unlock later only for eligible non-winners.', details: ['1 TRC token received', 'Use TRC for Travel Reward/TCR participation', 'Non-winner DC unlocks after result'], img: '/images/lucky_draw_ticket_1779521667122.png' },
    { n: '04', icon: Gift, title: 'Travel & Save', desc: 'Use your TRC for win-entry participation. If you remain a non-winner, apply the issued Discount Credit on eligible paid tour bookings.', details: ['Winner benefits for selected members', 'Domestic DC for Domestic tours only', 'International DC for International tours only'], img: '/images/happy_family_travelers.png' },
  ];
  return (
        ...
        <Reveal>
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="font-display text-4xl lg:text-6xl font-bold text-ink leading-tight">
              ...
              <br /><span className="gradient-neon"><KineticText text="available value." delay={0.4} /></span>
            </h2>
          </div>
        </Reveal>
        ...
        <Reveal>
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-white/80 text-base lg:text-lg leading-relaxed max-w-2xl mx-auto">
              Trust isn't claimed - it's proven. Our weekly winner selections use certified RNG, are live-streamed, and archived as downloadable audit reports.
            </p>
          </div>
        </Reveal>
