...
6. All subscription benefits are applicable only to active subscribers.`
    ...
    {
      id: 'B',
      title: 'B. Travel Reward Selection Rules',
...
10. The Company's decision regarding member selection shall be final and binding.
...
13. A minimum of 5% of the total valid participants will be selected for winner benefits every week, using the "Round-Up" rule.
14. The selection may be conducted live, recorded, or through an automated digital platform.
15. Selected-member notifications may be published through the Company Website, Mobile App, Social Media Platforms, SMS, Email, or any other official communication channel.`
    },
    {
      id: 'C',
      title: 'C. Winner Benefits & Conditions',
      content: `16. Selected member tour benefits cannot be exchanged for cash or any monetary compensation.
17. Selected member tour benefits cannot be exchanged for any other tour package, service, voucher, or offer.
18. Selected member tours will be conducted only on destinations, dates, and itineraries selected by the Company.
19. Selected members must confirm their participation within 15 days of the announcement or invitation. Failure to do so may result in cancellation of the benefit.
20. If a winner fails to join the allocated tour, the benefit shall be considered forfeited.
21. Selected member tour benefits are non-transferable except where Name Change benefits are specifically allowed under the subscriber's plan.
22. Selected members must provide valid government-issued identification before joining the tour.
...
24. A subscriber may avail Selected member tour benefits only once during the validity period of a subscription.`
    },
    {
      id: 'D',
...
56. Subscribers are solely responsible for complying with local laws, regulations, and authorities during their travels.`
    },
    {
      ...
      content: `57. Selected members and participants grant Beduin Tour & Travels the right to use their names, photographs, videos, testimonials, and tour experiences for promotional, marketing, and advertising purposes.
58. By purchasing a subscription, the subscriber provides consent for such usage without any additional compensation.`
    },
    {
      ...
      content: `59. The Beduine Travel Reward Program is a promotional membership benefit program and shall not be considered a lottery, gambling, betting, or wagering activity.
        ...
        <Reveal>
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-slate-400 text-sm max-w-2xl mx-auto font-mono">
              "Choose Your Plan. Unlock Your Winner Benefit. Travel Beyond Limits."
            </p>
          </div>
        </Reveal>
