...
export function DiscountCreditsSection() {
  ...
  const credits = [
    { type: 'TRC', name: 'Travel Reward Credit', icon: Sparkles, accent: 'cyan',
      desc: '1 Credit is issued per subscription. This credit acts as a token that the user manually spends on the mobile app/web portal on Sunday to lock their participation in that week\'s winner selection.',
    ...
    { type: 'DC', name: 'Discount Credits', icon: CreditCard, accent: 'teal',
      desc: 'These unlock only after a member uses TRC for Lucky Draw/TCR participation and remains a non-winner. They provide a flat discount during eligible paid tour booking.',
      rule: '1 Tour Booking = 1 Discount Credit applied',
      details: [
        'Eligible domestic non-winners receive 1 × ₹500 Domestic Discount Credit.',
        'Eligible international non-winners receive 1 × ₹5,000 International Discount Credit.',
        'Domestic and International credits cannot be cross-used.',
        'Credits are issued after result publication and remain valid up to subscription expiry'
      ] },
  ];
  ...
  const domesticCredits = [
    ...
    { plan: 'Gold', price: '₹799', trc: '1', dc: '1 × ₹500', total: '₹500', color: 'from-teal-400 to-emerald-600', image: '/images/darjeeling_tea_1779521805614.png' },
    { plan: 'Platinum', price: '₹1,499', trc: '1', dc: '1 × ₹500', total: '₹500', color: 'from-neon-gold to-gold-deep', image: '/images/kashmir_dal_lake_1779521728036.png' },
  ];

  const intlCredits = [
    { plan: 'Silver', price: '₹4,999', trc: '1', dc: '1 × ₹5,000', total: '₹5,000', color: 'from-sky-400 to-blue-600', image: '/images/nepal.png' },
    { plan: 'Gold', price: '₹7,999', trc: '1', dc: '1 × ₹5,000', total: '₹5,000', color: 'from-emerald-400 to-teal-600', image: '/images/thailand.png' },
    { plan: 'Platinum', price: '₹14,999', trc: '1', dc: '1 × ₹5,000', total: '₹5,000', color: 'from-cyan via-cyan-bright to-cyan-deep', image: '/images/vietnam.png' },
  ];
        ...
        <Reveal>
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="font-display text-4xl lg:text-6xl font-bold text-ink leading-tight">
              <KineticText text="TRC first," />
              <br /><span className="gold-shimmer"><KineticText text="DC after result." delay={0.3} /></span>
            </h2>
            <p className="mt-6 text-ink/70 text-lg leading-relaxed">Every subscriber receives TRC first. Discount Credit is issued later only when that TRC is used for participation and the member remains a non-winner.</p>
          </div>
        </Reveal>
              ...
              <div className="rounded-3xl p-8 border h-full tilt-inner flex flex-col justify-between overflow-hidden relative transition-all duration-500 border-teal-500/20 glass glass-glow-teal shadow-lg shadow-teal-500/5">
                ...
                <div className="rounded-xl p-3.5 bg-slate-950/65 border border-slate-800/80 flex items-center justify-between text-xs font-mono text-slate-300 font-semibold shadow-inner relative z-10">
                  ...
                  <span className="text-[#00C7A3] font-bold flex items-center gap-1.5">
                    <ShieldCheck className="w-4 h-4 text-[#00C7A3]" /> Available DC
                  </span>
                </div>
              </div>
            </TiltCard>
        ...
        <Reveal>
          <div className="glass rounded-3xl p-6 lg:p-8 border border-slate-line mb-12">
            <div className="text-center mb-8">
              ...
              <div className="font-display text-xl lg:text-2xl font-bold text-ink mb-6">What you get - available</div>
