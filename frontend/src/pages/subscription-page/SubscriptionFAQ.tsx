...
export function SubscriptionFAQ() {
  const faqs = [
    ...
    { q: 'How are winners chosen?', a: 'Winners are chosen through RNG or an approved automated digital system from active valid participants.' }
  ];
          ...
          <div className="promise-box">
            <div className="flex flex-col lg:flex-row items-center gap-6 text-center lg:text-left">
              ...
              <a href="#plans" className="shrink-0">
                <ParticleButton as="span" variant="gold" className="px-6 py-3.5 rounded-full font-extrabold text-sm inline-flex items-center gap-2 shadow-lg hover:scale-105 transition-transform">
