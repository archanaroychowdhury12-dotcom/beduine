  ...
  return (
    <>
      <div className="no-print fixed bottom-0 inset-x-0 z-999 z-50 p-4 sm:p-5 select-none animate-fadeIn">
        <div className="max-w-6xl mx-auto rounded-[24px] border border-white/10 bg-slate-950/40 backdrop-blur-xl shadow-2xl p-5 flex flex-col md:flex-row items-center justify-between gap-5 relative overflow-hidden">
          ...
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-xl bg-cyan/10 flex items-center justify-center text-cyan shrink-0 mt-0.5">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <div className="text-left">
              <h4 className="font-display font-bold text-sm text-white mb-1">Your privacy choices</h4>
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto justify-end shrink-0">
            <button
              ...
              className="px-4 py-2.5 rounded-full border border-white/10 text-xs font-bold text-white bg-white/5 hover:bg-white/10 transition-all cursor-pointer flex items-center gap-1.5 focus:outline-none"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-full border border-white/10 text-xs font-bold text-white bg-white/5 hover:bg-white/10 transition-all cursor-pointer focus:outline-none"
            >
              Reject Optional
            </button>
            <button
              onClick={handleAcceptAll}
              className="px-5 py-2.5 rounded-full text-xs font-bold text-slate-950 bg-cyan hover:bg-cyan/90 transition-all cursor-pointer border-none shadow-md shadow-cyan-950/10"
            >
              Accept All
            </button>
          </div>
