...
export interface CreditLedgerEntry {
  ...
  creditType: 'travel_winner benefit' | 'domestic_discount' | 'international_discount';
...
export const INTL_PLANS: SubscriptionPlan[] = [
  {
    ...
    benefits: ['1 Weekly Promotional Draw entry', 'Member benefit travel value up to ₹25,000 (3N/4D)', '₹5,000 discount credit if not selected', 'Up to 5% off on paid international tours', 'One-time family name change allowed', '18+ Membership Only'],
  ...
  },
  {
    ...
    benefits: ['1 Weekly Promotional Draw entry', 'Member benefit travel value up to ₹50,000 (4N/5D)', '₹10,000 discount credits if not selected', 'Up to 7% off on paid international tours', 'Two family name changes allowed', '18+ Membership Only'],
    tripCategory: 'international',
  },
  {
    ...
    benefits: ['1 Weekly Promotional Draw entry', 'Member benefit travel value up to ₹1,00,000 (5N/6D)', '₹20,000 discount credits if not selected', 'Up to 10% off on paid international tours', 'Unlimited name changes allowed', '18+ Membership Only'],
    tripCategory: 'international',
  },
];
```
...
const newLedgerEntries: CreditLedgerEntry[] = [
  {
    ...
    date: dateStr,
    type: 'issued',
    creditType: 'travel_winner benefit',
    category: 'none',
    amount: 1,
    valuePerCredit: 0,
    totalValue: 0,
  ...
  },
  {
    ...
    reason: `Subscription signup winner benefit - ${creditsToIssue} ${tripCategory} Discount Credit(s) issued`,
    source: paymentMethod === 'demo_wallet' ? 'demo' : 'real',
  },
];
```
